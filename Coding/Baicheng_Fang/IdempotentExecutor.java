...
public class IdempotentExecutor<T> {
    ...
    public static void main(String[] args) {
        ...
        if (callCount[0] != 1) {
            System.out.println("FAIL Test 1: operation should have been called once, was called "
                    + callCount[0] + " times");
            return;
        }
        ...
        if (callCount[0] != 2) {
            System.out.println("FAIL Test 3: new requestId should trigger a new execution, call count = "
                    + callCount[0]);
            return;
        }
